...
enum errores{SINTAX_ERROR,E10001,E10002,E20001,E20002,
E20003,E30001,E30002,E30003,E30004,E40001,E40002,
E50001,E50002,E60001};

//14 errores

char* palabrasReservadas[9]=
{"abrir","concentrar","asignar","wait",
...
int main(int argc, char* argv[]){
    ...
    while(fgets(line, sizeof(line), escriptorio) && line[0] !='\0'){
    	...
    	if(huboError(rtaEjecucion)){return -1;}
    }
/*
...
//---------------------------------------------------------------------
int huboError(int ejecucion){

switch(ejecucion){
    	case SINTAX_ERROR:
    			errorSintactico();return 1;
    	case E10001:
    			printf("ERROR 10001");return 1;
    	case E10002:
    			printf("ERROR 10002");return 1;
    	case E20001:
    			printf("ERROR 20001");return 1;
    	case E20002:
    			printf("ERROR 20002");return 1;
    	case E20003:
    	    		printf("ERROR 20003");return 1;
    	case E30001:
    	    		printf("ERROR 30001");return 1;
    	case E30002:
    	    		printf("ERROR 30002");return 1;
    	case E30003:
    	    		printf("ERROR 30003");return 1;
    	case E30004:
    	    		printf("ERROR 30004");return 1;
    	case E40001:
    	    		printf("ERROR 40001");return 1;
    	case E40002:
    	    		printf("ERROR 40002");return 1;
    	case E50001:
    	    		printf("ERROR 50001");return 1;
    	case E50002:
    	    		printf("ERROR 50002");return 1;
    	case E60001:
    	    		printf("ERROR 60001");return 1;
    	default:return 0;
}
//---------------------------------------------------------------------
...
for(int k=0;k<9;k++){ //k<9 por la cantidad de palabras reservadas
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[0])){
	//caso abrir
	//*ejecutar abrir*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[1])){
	//caso concentrar
	//*ejecutar concentrar*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[2])){
	//caso asignar
	//*ejecutar asignar*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[3])){
	//caso wait
	//*ejecutar wait*
	int resultado = wait();
	//siempre 100
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[4])){
	//caso signal
	//*ejecutar signal*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[5])){
	//caso close
	//*ejecutar close*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[6])){
	//caso flush
	//*ejecutar flush*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[7])){
	//caso crear
	//*ejecutar crear*
...
if(string_equals_ignore_case(tipoPalabra(linea),palabrasReservadas[8])){
	//caso borrar
	//*ejecutar borrar*
